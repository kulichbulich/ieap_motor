...
//
// Kopie ../testing_firmware/include/board_pins.h - drz ji s nim v souladu.
// Zamerne je to kopie a ne symlink: kazdy projekt musi jit prelozit sam.
...
// U4.13 (~OE) je natvrdo na GND, U4.10 (~SRCLR) na +3V3. Vystupy jsou tedy
// zive uz od privedeni napajeni - firmware musi jako prvni vec zapsat
// SR_ALL_DISABLED, driv nez se cokoli jineho rozjede.
...
// Enkoder N je na kanalu N muxu (konektory encoder0..3). Tenhle firmware
// enkodery nepouziva.

// --- Koncove spinace (10k pull-up na +3V3, 10R do serie) ---
static constexpr uint8_t PIN_ENDSWITCH[4] = {13, 14, 15, 16};

// --- Debug UART na listu J5 (NE vychozi IO43/IO44) ---
static constexpr uint8_t PIN_UART_DBG_TX = 2;   // J5.2
static constexpr uint8_t PIN_UART_DBG_RX = 1;   // J5.3
