...
// nedela. Az bude potreba jet ctyrmi motory najednou nebo mezitim cist
// enkodery, tohle se bude muset prepsat na timer.
//
...
class Stepper {
 public:
  ...
  // + = smer A (DIR v L), - = smer B. Blokuje az do konce pohybu.
